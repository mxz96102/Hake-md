...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(1), __webpack_require__(0), __webpack_require__(0)) :
...
var _EditorStore = __webpack_require__(5);
...
var _WrapTool = __webpack_require__(9);

var _WrapTool2 = _interopRequireDefault(_WrapTool);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = new _EditorStore2.default();
var Tools = (0, _WrapTool2.default)([{ type: "h" }, { type: "italic" }, { type: "bold" }, { type: "delline" }, { type: "quote" }, { type: "link" }, { type: "image" }, { type: "horiz" }, { type: "code" }, { type: "list" }], store);

(0, _reactDom.render)(_react2.default.createElement(
  "div",
  null,
  _react2.default.createElement(_Editor2.default, { store: store,
    tools: Tools
  })
...
function wrapText(mode, text) {
  var Wrapper = {
    ...
    "delline": function delline(text) {
      return "~~" + text + "~~";
    },
    "list": function list(text) {
      return "- " + text + "<br/>";
    },
    "image": function image(text) {
      return "![](" + text + ")";
    },
    "italic": function italic(text) {
      return "*" + text + "*";
    },
    "horiz": function horiz(text) {
      return "---<br/>" + text;
    },
...
var EditorStore = (_class = function () {
  ...
  _createClass(EditorStore, [{
    key: "modifyChange",
    value: function modifyChange(type) {
      if (1) {
    ...
    key: "mdRender",
    value: function mdRender() {
      document.querySelector('.hake-pre').innerHTML = (0, _marked2.default)(document.querySelector('.hake-text').innerText);
    }
  }]);

  return EditorStore;
}(), (_applyDecoratedDescriptor(_class.prototype, "modifyChange", [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, "modifyChange"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "mdRender", [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, "mdRender"), _class.prototype)), _class);
...
var Editor = (0, _mobxReact.observer)(_class = (_class2 = function (_React$Component) {
  ...
  function Editor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Editor.__proto__ || Object.getPrototypeOf(Editor)).call.apply(_ref, [this].concat(args))), _this), _initDefineProp(_this, "newTodoTitle", _descriptor, _this), _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Editor, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "hake-editor" },
        _react2.default.createElement(
          "div",
          { className: "hake-input" },
          _react2.default.createElement(
            "div",
            { className: "hake-toolbox" },
            this.props.tools
          ),
          _react2.default.createElement("div", { contentEditable: "true", className: "hake-text" })
        ),
        _react2.default.createElement("div", { className: "hake-pre" })
      );
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      document.querySelector('.hake-text').addEventListener('input', (0, _lodash2.default)(function () {
        return __self.props.store.mdRender();
      }, 300));
    }
  }]);
...
function WrapTool(list, store) {
  var _class;

  var Tool = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(Tool, [{
      key: 'componentDidMount',
      value: function componentDidMount() {
        _reactDom2.default.findDOMNode(this).addEventListener('click', this.onClick.bind(this));
      }
    }, {
      key: 'componentWillUnmount',
      value: function componentWillUnmount() {
        _reactDom2.default.findDOMNode(this).removeEventListener('click', this.onClick.bind(this));
      }
    }, {
      key: 'onClick',
  ...
  for (var i in list) {
    list[i].type && tools.push(_react2.default.createElement(Tool, _extends({ store: store, key: i }, list[i])));
  }
...
var Button = (0, _mobxReact.observer)(function (_ref) {
  var type = _ref.type,
      alt = _ref.alt;
  return _react2.default.createElement(
    "div",
    { className: "button" },
    _react2.default.createElement("img", { src: "/button/" + type + ".png", alt: alt })
  );
});
